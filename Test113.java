...
public class Test113 {
	public static void main(String[] args) {
		...
		//计算双曲正切
		System.out.println("Math.tanh(1.2):"+ Math.tanh(2.1));
		//将矩形坐标(x,y)转换为极坐标(r,thet)
		System.out.println("Math.atan2(0.1, 0.1):"+ Math.atan2(0.1, 0.2));
